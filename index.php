	...
	<div class="container">
      <div class="row login-container">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 logo-container text-center">
          <img src="library/assets/neust_logo.png" alt="logo" class="logo mt-5">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-container text-center">
          ...
          <div class="d-flex justify-content-center">
            <form class="login-form">
              <input type="text" name="username" placeholder="Username." class="form-control field">
              <input type="password" name="password" placeholder="Password." class="form-control field spacer">
              <button type="submit" class="m-2 login-button">Log-In</button>
            </form>
          </div>
